...
//#component
class All_Led_BlinkComponent : public ComponentBase, public ProgramComponentBase, private Loggable<All_Led_BlinkComponent>
{
public: // typedefs

public: // construction/destruction
#if ARP_ABI_VERSION_MAJOR < 2
    All_Led_BlinkComponent(IApplication& application, const String& name);
    virtual ~All_Led_BlinkComponent() = default;
#else
    All_Led_BlinkComponent(ILibrary& library, const String& name);
#endif
...
private: // methods
#if ARP_ABI_VERSION_MAJOR < 2
    All_Led_BlinkComponent(const All_Led_BlinkComponent& arg) = delete;
    All_Led_BlinkComponent& operator= (const All_Led_BlinkComponent& arg) = delete;
...
private: // fields
    All_Led_BlinkComponentProgramProvider programProvider;
...
#if ARP_ABI_VERSION_MAJOR < 2
inline IComponent::Ptr All_Led_BlinkComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new All_Led_BlinkComponent(application, name));
}
#endif
